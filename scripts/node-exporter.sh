...
echo "Create a directory for node_exporter and navigate to it"
...
echo "Extract the downloaded archive"
...
echo "Create a systemd service file for node_exporter"
...
echo "Make sure the node_exporter binary is executable"
